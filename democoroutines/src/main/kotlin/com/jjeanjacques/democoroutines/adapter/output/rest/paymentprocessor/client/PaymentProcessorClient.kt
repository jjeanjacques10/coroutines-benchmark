package com.jjeanjacques.democoroutines.adapter.output.rest.paymentprocessor.client

import com.jjeanjacques.democoroutines.adapter.output.rest.paymentprocessor.request.PaymentProcessorRequest
import com.jjeanjacques.democoroutines.adapter.output.rest.paymentprocessor.response.PaymentProcessorResponse
...
class PaymentProcessorClient(
    ...
    companion object {
        private val log = LoggerFactory.getLogger(PaymentProcessorClient::class.java)
    }
}
